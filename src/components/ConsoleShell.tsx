...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/console/locations", label: "Locations", roles: ["COACH"] },
      ...
      { href: "/console/subs", label: "Session Subs", roles: ["COO", "DIRECTOR"], match: ["/console/subs"] },
    ],
  },
  {
    title: "Money & comms",
    items: [
      ...
      { href: "/console/stats", label: "Stats", roles: ["COO", "CEO", "DIRECTOR"], match: ["/console/stats"] },
      { href: "/console/pnl", label: "P&L", roles: ["COO", "CEO", "DIRECTOR"], match: ["/console/pnl"] },
