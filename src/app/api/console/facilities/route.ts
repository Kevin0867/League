...
export async function POST(req: Request) {
  ...
  const data = {
    ...
    courtCostEveningCents: centsOrNull(formData.get("courtCostEvening")),
    courtCostWeekendCents: centsOrNull(formData.get("courtCostWeekend")),
    courtEveningStartsAt: String(formData.get("courtEveningStartsAt") ?? "").trim() || null,
